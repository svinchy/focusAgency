export const Feedbacks = {
  ...
  CarouselWrap: {
    ...
    FocusFrame: {
      ...
      CornerOne: { extends: 'Box', position: 'absolute', top: '-0.4em', left: '-0.4em', width: '1em', height: '1em', ':before': { position: 'absolute', top: '0', left: '0', width: '100%', height: '2px', background: 'red', style: { content: "''" } }, ':after': { position: 'absolute', top: '0', left: '0', width: '2px', height: '100%', background: 'red', style: { content: "''" } } },
      CornerTwo: { extends: 'Box', position: 'absolute', top: '-0.4em', right: '-0.4em', width: '1em', height: '1em', ':before': { position: 'absolute', top: '0', right: '0', width: '100%', height: '2px', background: 'red', style: { content: "''" } }, ':after': { position: 'absolute', top: '0', right: '0', width: '2px', height: '100%', background: 'red', style: { content: "''" } } },
      CornerThree: { extends: 'Box', position: 'absolute', bottom: '-0.4em', left: '-0.4em', width: '1em', height: '1em', ':before': { position: 'absolute', bottom: '0', left: '0', width: '100%', height: '2px', background: 'red', style: { content: "''" } }, ':after': { position: 'absolute', bottom: '0', left: '0', width: '2px', height: '100%', background: 'red', style: { content: "''" } } },
      CornerFour: { extends: 'Box', position: 'absolute', bottom: '-0.4em', right: '-0.4em', width: '1em', height: '1em', ':before': { position: 'absolute', bottom: '0', right: '0', width: '100%', height: '2px', background: 'red', style: { content: "''" } }, ':after': { position: 'absolute', bottom: '0', right: '0', width: '2px', height: '100%', background: 'red', style: { content: "''" } } },
