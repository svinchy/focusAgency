  ...
  Members: {
    ...
    Member1: {
      ...
      style: {
        ...
        height: '25em',
        willChange: 'transform',
        transition: 'opacity 0.2s cubic-bezier(0.4,0,0.2,1), box-shadow 0.24s cubic-bezier(0.4,0,0.2,1), border-color 0.24s cubic-bezier(0.4,0,0.2,1)',
        border: '1px solid rgba(255, 241, 227, 0.5)',
        borderRadius: '2em',
      },
      overflow: 'hidden',
      ':after': {
      ...
      Img: {
        ...
        height: '90%',
        zIndex: '1',
        style: { objectFit: 'cover', transform: 'scale(0.9)', transition: 'transform 0.9s cubic-bezier(0.25,0.1,0.25,1)' },
        attr: { src: '/IMAGE/choni2.webp', alt: 'Giorgi' },
      },
      H6: { tag: 'h6', text: 'Founder', position: 'absolute', top: '1em', zIndex: '3', fontSize: '1em', color: 'creamMuted', fontWeight: '400', textTransform: 'uppercase', style: { fontFamily: "'Exo 2', sans-serif", padding: '0 0 0 1.35em', transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      H5: { tag: 'h5', text: 'Giorgi', position: 'absolute', bottom: '1em', left: '1em', zIndex: '3', fontSize: '2.2em', color: 'cream', fontWeight: '900', maxWidth: '2em', lineHeight: '1em', style: { fontFamily: "'Exo 2', sans-serif", transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      SocialLinks: {
        extends: 'Flex',
        ...
        zIndex: '3',
        gap: 'Z',
        style: { transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' },
        A1: { tag: 'a', attr: { href: '' }, Img: { tag: 'img', height: '2em', attr: { src: '/IMAGE/facebook.png' } } },
        A2: { tag: 'a', attr: { href: '' }, Img: { tag: 'img', height: '2em', attr: { src: '/IMAGE/linkedin.png' } } },
      },
    ...
    Member2: {
      ...
      overflow: 'hidden',
      style: {
        minWidth: '20em', maxWidth: '20em', height: '25em',
        willChange: 'transform',
        transition: 'opacity 0.2s cubic-bezier(0.4,0,0.2,1), box-shadow 0.24s cubic-bezier(0.4,0,0.2,1), border-color 0.24s cubic-bezier(0.4,0,0.2,1)',
        border: '1px solid rgba(255, 241, 227, 0.5)', borderRadius: '2em',
      },
      ':after': { position: 'absolute', top: '0', left: '0', right: '0', bottom: '0', width: '100%', height: '100%', background: 'linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%)', opacity: '0.85', zIndex: '2', pointerEvents: 'none', style: { content: "''" } },
      Img: { tag: 'img', position: 'absolute', bottom: '0', width: '100%', height: '90%', zIndex: '1', style: { objectFit: 'cover', transform: 'scale(0.9)', transition: 'transform 0.9s cubic-bezier(0.25,0.1,0.25,1)' }, attr: { src: '/IMAGE/liza2.webp', alt: 'Liza' } },
      H6: { tag: 'h6', text: 'Project Manager', position: 'absolute', top: '1em', zIndex: '3', fontSize: '1em', color: 'creamMuted', fontWeight: '400', textTransform: 'uppercase', style: { fontFamily: "'Exo 2', sans-serif", padding: '0 0 0 1.35em', transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      H5: { tag: 'h5', text: 'Liza', position: 'absolute', bottom: '1em', left: '1em', zIndex: '3', fontSize: '2.2em', color: 'cream', fontWeight: '900', maxWidth: '2em', lineHeight: '1em', style: { fontFamily: "'Exo 2', sans-serif", transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      SocialLinks: {
        extends: 'Flex', attr: { 'data-el': 'social-links' }, position: 'absolute', top: '1.2em', right: '1.5em', zIndex: '3', gap: 'Z',
        style: { transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' },
        A1: { tag: 'a', attr: { href: '' }, Img: { tag: 'img', height: '2em', attr: { src: '/IMAGE/facebook.png' } } },
        A2: { tag: 'a', attr: { href: '' }, Img: { tag: 'img', height: '2em', attr: { src: '/IMAGE/linkedin.png' } } },
      },
    ...
    Member3: {
      ...
      ':after': { position: 'absolute', top: '0', left: '0', right: '0', bottom: '0', width: '100%', height: '100%', background: 'linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%)', opacity: '0.85', zIndex: '2', pointerEvents: 'none', style: { content: "''" } },
      Img: { tag: 'img', position: 'absolute', bottom: '0', width: '100%', height: '90%', zIndex: '1', style: { objectFit: 'cover', transform: 'scale(0.9)', transition: 'transform 0.9s cubic-bezier(0.25,0.1,0.25,1)' }, attr: { src: '/IMAGE/mariami2.webp', alt: 'Mariami' } },
      H6: { tag: 'h6', text: 'Graphic Designer', position: 'absolute', top: '1em', zIndex: '3', fontSize: '1em', color: 'creamMuted', fontWeight: '400', textTransform: 'uppercase', style: { fontFamily: "'Exo 2', sans-serif", padding: '0 0 0 1.35em', transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      H5: { tag: 'h5', text: 'Mariami', position: 'absolute', bottom: '1em', left: '1em', zIndex: '3', fontSize: '2.2em', color: 'cream', fontWeight: '900', maxWidth: '2em', lineHeight: '1em', style: { fontFamily: "'Exo 2', sans-serif", transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      SocialLinks: {
        extends: 'Flex', attr: { 'data-el': 'social-links' }, position: 'absolute', top: '1.2em', right: '1.5em', zIndex: '3', gap: 'Z',
        style: { transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' },
        A1: { tag: 'a', attr: { href: '' }, Img: { tag: 'img', height: '2em', attr: { src: '/IMAGE/facebook.png' } } },
    ...
    Member4: {
      ...
      ':after': { position: 'absolute', top: '0', left: '0', right: '0', bottom: '0', width: '100%', height: '100%', background: 'linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%)', opacity: '0.85', zIndex: '2', pointerEvents: 'none', style: { content: "''" } },
      Img: { tag: 'img', position: 'absolute', bottom: '0', width: '100%', height: '90%', zIndex: '1', style: { objectFit: 'cover', transform: 'scale(0.9)', transition: 'transform 0.9s cubic-bezier(0.25,0.1,0.25,1)' }, attr: { src: '/IMAGE/luka2.webp', alt: 'Luka' } },
      H6: { tag: 'h6', text: 'Videograph', position: 'absolute', top: '1em', zIndex: '3', fontSize: '1em', color: 'creamMuted', fontWeight: '400', textTransform: 'uppercase', style: { fontFamily: "'Exo 2', sans-serif", padding: '0 0 0 1.35em', transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      H5: { tag: 'h5', text: 'Luka', position: 'absolute', bottom: '1em', left: '1em', zIndex: '3', fontSize: '2.2em', color: 'cream', fontWeight: '900', maxWidth: '2em', lineHeight: '1em', style: { fontFamily: "'Exo 2', sans-serif", transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' } },
      SocialLinks: {
        extends: 'Flex', attr: { 'data-el': 'social-links' }, position: 'absolute', top: '1.2em', right: '1.5em', zIndex: '3', gap: 'Z',
        style: { transition: 'opacity 0.22s cubic-bezier(0.4,0,0.2,1), transform 0.22s cubic-bezier(0.4,0,0.2,1)' },
        A1: { tag: 'a', attr: { href: '' }, Img: { tag: 'img', height: '2em', attr: { src: '/IMAGE/facebook.png' } } },
